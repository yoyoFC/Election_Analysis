...
with open(file_to_save, "w") as txt_file:
    ...
    for county in county_votes:
        ...
        county_result = (
            f"\n{county}: {county_vote_perc:.1f}({county_vote_count:,})")
        print(county_result)
        ...
        if (winning_county_count < county_vote_count) and (winning_county_percentage < county_vote_perc):
            winning_county = county
            winning_county_percentage = county_vote_perc
    ...
    winning_county_result = (
        ...
        f"#Votes: {winning_county_count:,}\n"
        f"Percentage: {winning_county_percentage:.1f}\n"
        f"-------------------------------------------\n\n"
